CREATE TABLE `associations` (
  ...
  `base_location_suffix` enum('', '2','3','4','5','6','7','8','9') NOT NULL DEFAULT '',
  `assoc_location_suffix` enum('', '2','3','4','5','6','7','8','9') NOT NULL DEFAULT '',
...
CREATE TABLE `schedules` (
  ...
  `runs_sa` tinyint(1) NOT NULL,
  `runs_su` tinyint(1) NOT NULL,
  `bank_hol` enum('','X','G') NOT NULL DEFAULT '',
  `status` enum('','1','2','3','4','5','B','F','P','S','T') NOT NULL DEFAULT '',
  `category` char(2) NOT NULL,
  `train_identity` char(4) NOT NULL,
  `headcode` char(4) NOT NULL,
  `service_code` char(8) NOT NULL,
  `portion_id` char(1) NOT NULL DEFAULT '',
  `power_type` enum('','D','DEM','DMU','E','ED','EML','EMU','EPU','HST','LDS') NOT NULL DEFAULT '',
  `timing_load` char(4) NOT NULL,
  `speed` char(3) NOT NULL,
  `operating_characteristics` char(6) NOT NULL,
  `train_class` enum('','B','S') NOT NULL DEFAULT '',
  `sleepers` enum('','B','S','F') NOT NULL DEFAULT '',
  `reservations` enum('','A','R','S','E') NOT NULL DEFAULT '',
  `catering_code` char(4) NOT NULL,
  `service_branding` char(4) NOT NULL,
  ...
  `rsid` char(8) NOT NULL,
  `data_source` enum('','0','T') NOT NULL DEFAULT '',
